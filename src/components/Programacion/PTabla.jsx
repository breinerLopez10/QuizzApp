...
const PTabla = ({dato, setDato, datos, setListUpdated}) => {
...
const requestInit = {
    ...
    method: 'DELETE'
        ...
        fetch('http://localhost:9000/api5' + id, requestInit)
    ...
    let {Tema, Descripcion, respuestas, respuesta_correcta} = dato
    const handleUpdate = id => {
        //validación de los datos
        if (Tema === '' || Descripcion === '' || respuestas === ''|| respuesta_correcta === '') {
