...
-- Tiempo de generación: 05-02-2023 a las 06:44:30
...
CREATE TABLE IF NOT EXISTS `datos` (
  ...
  `respuestas` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `respuestas2` varchar(300) COLLATE utf8_spanish_ci NOT NULL,
  `respuestas3` varchar(300) COLLATE utf8_spanish_ci NOT NULL,
  `respuestas4` varchar(300) COLLATE utf8_spanish_ci NOT NULL,
  `respuesta_correcta` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `Puntaje` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `datos` (`id`, `Tema`, `Descripcion`, `respuestas`, `respuestas2`, `respuestas3`, `respuestas4`, `respuesta_correcta`, `Puntaje`) VALUES
(43, 'Fracciones', 'la tercera parte de un numero menos 1, es igual a la sexta parte del mismo numero	', 'a)6', '3', 'c)8', '4', 'b', 2),
(41, 'Fracciones', '¿Cuánto es la cuarta parte de la tercera parte?', 'a)1/7	', 'b)1/12', 'c)1/3', 'd)1/4	', 'b', 5),
(42, 'CONJUNTOS2', 'Sean los conjuntos: A:{2, 5, 6, 3, 0} B:{1, 9,7, 4} ¿Cuál es resultado de la operación A ∩ B ?	', 'a)12', 'b)24', 'c)34', 'd)41', 'a', 2);
